  ...
  <div class="pageChat">
                      ...
                      <div class="chat-send">
                        ...
                        >
                          ...
                          <template #reference>
                            ...
                            <div
                              v-show="item.imgUrl != null && item.imgUrl != ''"
                              style="margin-right: 10px"
                            >
                              <van-image
                                :src="item.imgUrl"
                            ...
                            <div
                              ...
                              "
                              @click.prevent="
                                downloadDocument(item.documentUrl)
                              "
                              style="margin-right: 10px"
                            >
                              <div class="z-flex-justify-between document_wpr">
                                ...
                                <van-image
                                  :src="
                                    utils.get_img_url('pageChat/document.png')
                                  "
                                  width="40"
                                  height="40"
                                />
                            ...
                            <span style="margin-right: 10px;font-size: 12px;">{{ item.msgStatus== '0'?'未读':'已读' }}</span>
                              ...
                              >
                                ...
                                <audio ref="audios" @ended="onAudioEnded()">
                          ...
                          <template #reference>
                            ...
                            >
                              ...
                              >
                                ...
                                >
                                  <div
                                    class="z-flex-justify-between document_wpr"
                                  >
                                    <div class="z-line-1">
                                      {{ item.fileName }}
                                    </div>
      ...
      <div v-show="isCollapse">
        ...
        <van-grid :border="false" :column-num="4">
          <van-grid-item v-for="item in imgUrl" :key="item.text">
            <van-uploader
              v-if="item.text == '照片' || item.text == '文件'"
              :preview-image="false"
            ...
            <div class="z-flex-column-center" v-else @click="changeItem(item.text)">
              <van-image :src="utils.get_img_url(item.url)" />
              <div>{{ item.text }}</div>
            </div>
          </van-grid-item>
   ...
   <div class="footer" v-if=" forbid || userForbid">
    ...
    <van-overlay :show="show" @click.prevent="show = false" z-index="999">
      <div class="wrapper">
        <wave />
        <img class="ovImg" src="@/assets/image/pageChat/67139.png" />
        <div style="color: #d4d4d4ff">松开 发送</div>
        <img
          class="ovImg1"
          src="@/assets/image/pageChat/67142.png"
